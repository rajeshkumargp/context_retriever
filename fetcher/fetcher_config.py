...
RESULT_JSON = "current_run/fetcher_meta_data/class12_books_chapters_info.json"

# Settings for refine_extracted_urls.py
REFINE_SRC = "current_run/fetcher_meta_data/class12_books_chapters_info.json"
REFINE_DEST = (
    "current_run/fetcher_meta_data/class12_books_chapters_info_refined.json"
)

# Settings for get_books.py
TIMEOUT = 30
DOWNLOADED_BOOKS_STATUS_LOG_FILE_NAME = (
    "downloaded_classwise_subjects_chapters_status_sample.json"
)
